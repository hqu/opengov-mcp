...
// Default to Cambridge Open Data unless overridden by environment
const DEFAULT_BASE_URL = process.env.DATA_PORTAL_URL || DEFAULT_DATA_PORTAL_URL;

/**
 * Helper function to make API requests to Socrata endpoints
 */
export async function fetchFromSocrataApi<T>(
  path: string,
